        ...
        <div class="row">
          <div class="col-md-12 top-description-content">
            <div class="top-description-text" v-if="t.sectionInfo">
              ...
              <div v-html="t.sectionInfo.section1.description"></div>
      ...
      <div class="container-fluid dashboard-container-outer">
        <div class="row dashboard-container">
          ...
          <div class="col-md-12 chart-col version-select-container">
            <a :href="'./index.php?l='+language" class="link-button" :class="{active: selectedYear == ''}" v-if="t.filters">{{t.filters.allYears}}</a>
            <a v-for="year in dataYearsButtons" :href="'./index.php?y='+year+'&l='+language" class="link-button" :class="{active: selectedYear == year}">{{year}}</a>
          </div>
          <!-- CHARTS - FIRST ROW -->
          ...
          <div class="col-md-4 chart-col">
            <div class="boxed-container chart-container section1_chart_row1" id="institutioncategory_chart_container">
              <chart-header :title="charts.institutionCategory.title" :info="charts.institutionCategory.info" :chartid="charts.institutionCategory.id"></chart-header>
              <div class="chart-inner" id="institutioncategory_chart"></div>
            </div>
          </div>
          <div class="col-md-4 chart-col">
            <div class="boxed-container chart-container section1_chart_row1" id="institution_chart_container">
              <chart-header :title="charts.institution.title" :info="charts.institution.info" :chartid="charts.institution.id"></chart-header>
              <div class="chart-inner" id="institution_chart"></div>
            </div>
          </div>
          <!-- CHARTS - SECOND ROW -->
          <div class="col-md-3 chart-col">
            <div class="boxed-container chart-container section1_chart_row2" id="businessowner_chart_container">
              <chart-header :title="charts.businessOwner.title" :info="charts.businessOwner.info" :chartid="charts.businessOwner.id"></chart-header>
              <div class="chart-inner" id="businessowner_chart"></div>
            </div>
          </div>
          <div class="col-md-3 chart-col">
            <div class="boxed-container chart-container section1_chart_row2" id="businessshareholder_chart_container">
              <chart-header :title="charts.businessShareholder.title" :info="charts.businessShareholder.info" :chartid="charts.businessShareholder.id"></chart-header>
              <div class="chart-inner" id="businessshareholder_chart"></div>
            </div>
          </div>
          <div class="col-md-3 chart-col">
            <div class="boxed-container chart-container section1_chart_row2" id="companies_chart_container">
              <chart-header :title="charts.companies.title" :info="charts.companies.info" :chartid="charts.companies.id"></chart-header>
              <div class="chart-inner" id="companies_chart"></div>
            </div>
          </div>
          <div class="col-md-3 chart-col">
            <div class="boxed-container chart-container section1_chart_row2" id="indicators_chart_container">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              <div class="modal-title">
                {{selectedEntry.name}} - {{selectedEntry.year}}
              </div>
            ...
            <div class="modal-body">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <div class="details-line"><span class="details-line-title">Lorem:</span> ipsum</div>
                  </div>
                </div>
              </div>
            </div>
